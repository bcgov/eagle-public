...
@Component({
  selector: 'app-autocomplete-multi-select-2',
  templateUrl: './autocomplete-multi-select-2.component.html',
  styleUrls: ['./autocomplete-multi-select-2.component.scss']
})
export class AutoCompleteMultiSelect2Component implements OnInit {
