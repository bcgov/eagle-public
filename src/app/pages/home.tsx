...
const HERO_DESCRIPTION = "British Columbia's environmental assessment process provides opportunities for Indigenous Nations, government agencies and the public to influence the outcome of environmental assessments in British Columbia.";
...
const ABOUT_CARDS: { title: string; description: string; button: InfoCardButton }[] = [
  ...
  },
  {
    ...
    button: { text: 'Learn More', link: '/process', title: 'Learn more about process and procedures' }
  },
  {
    ...
    button: { text: 'Learn More', link: '/compliance-oversight', title: 'Learn more about compliance oversight' }
  }
];
            ...
            <div className="container">
              <div className="d-flex flex-column flex-md-row gap-3">
                <div className="flex-grow-1">
                  <h5 className="mb-3">Can you take a few minutes to help us improve your experience on EPIC?</h5>
                  <p className="mb-0">
                    We are working on some improvements to this website and would like to hear about your experience.
                    Please fill out a short 5-10 minute survey to help us design a better EAO Project Information Centre.
                    Thank you!
                  </p>
                </div>
                <div className="flex-shrink-0">
                  <a className="btn btn-primary survey-link" href={survey} rel="noopener" target="_blank">Share your thoughts</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div id="anchor-point">
            ...
            <div className="home-news-feed">
              ...
              {isPending ? (
                ...
                <table className="table" id="tableTop">
                  {results.filter(item => item.active).map(item => (
                    <tbody key={item._id}>
              ...
              <div className="mt-4 text-center">
                <Link className="btn slide-r-btn btn-outline-primary d-inline-flex align-items-center gap-2" to="/news">
          ...
          <div className="bg-faded mt-5">
            <section className="container">
              ...
              <p tabIndex={0}>
                Learn more about how the Environmental Assessment Office neutrally
                administers a process that is predictable, transparent, timely,
                procedurally fair, and holds all participants accountable.
              </p>
              <div className="feature-cards-container">
                {ABOUT_CARDS.map(card => (
                  <div className="feature-card" key={card.title}>
                    <InfoCard title={card.title} description={card.description} button={card.button} />
                  </div>
                ))}
              </div>
            </section>
