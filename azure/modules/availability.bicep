...
// Alerting is optional so the test can be deployed before an address is agreed. It records results
// either way — what an empty address costs is notification, not measurement.
